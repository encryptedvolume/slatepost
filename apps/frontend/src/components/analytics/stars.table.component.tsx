...
export const UpDown: FC<{
  ...
  return (
    <div
      className="flex gap-[4px] items-center select-none"
      onClick={changeState}
    >
      <div>{name}</div>
...
export const StarsTableComponent = () => {
  ...
  return (
    <div className="flex flex-1 flex-col gap-[16px] min-h-[426px]">
      <div className="text-textColor flex gap-[8px] items-center select-none">
        ...
        <h2 className="t-title-2">{t('stars_per_day', 'Stars per day')}</h2>
        <div
