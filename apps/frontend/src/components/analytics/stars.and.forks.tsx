    ...
    <>
      {list.map((item) => (
        <div className="flex gap-[24px] h-[272px]" key={item.login}>
          <div className="flex-1 bg-surface py-[8px] px-[16px] flex flex-col">
            ...
            <div className="flex-1 relative">
              <div className="absolute w-full h-full start-0 top-0">
                {item.stars.length ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center t-title-1">
      ...
      <div className="flex gap-[24px]">
        {[0, 1].map((p) => (
          <div
            key={p}
            className="flex-1 bg-surface py-[24px] px-[16px] gap-[16px] flex flex-col"
          >
            <div className="flex items-center gap-[16px]">
            ...
            <div className="flex items-center">
              <div className="w-[2px] h-[32px] bg-customColor11 me-[16px]"></div>
              <div className="t-title-2 flex-1">
              ...
              <div>
                <div className="rounded-pill bg-customColor14 w-[5px] h-[5px] mx-[8px]" />
              </div>
              <div
                className={clsx(
                  't-title-2',
