...
export const InformationComponent: FC<{
  ...
  return (
    ...
    >
      ...
      {!isGlobal && (
        <div className={clsx("t-caption-strong flex justify-center items-center", !isValid && 'text-ink')}>
      ...
      {((isGlobal && selectedIntegrations.length) || !isValid) && (
        <svg
          className={clsx('group-hover:rotate-180', !isValid && 'text-ink')}
          xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
          viewBox="0 0 16 16"
      ...
      {((isGlobal && selectedIntegrations.length) || !isValid) && (
        ...
        >
          {!isPicture && !totalChars && (
            <div
              className={clsx(
                't-secondary text-critical whitespace-nowrap',
          ...
          {isGlobal && (
            <div className="grid grid-cols-[auto_auto_auto] t-control gap-[8px] items-center">
