...
export const CommentBox: FC<{
  ...
  return (
    <div
      className={clsx(
        'flex',
        type === 'textarea' ? 'flex-col' : 'flex-row flex items-end gap-[8px]'
      )}
    >
      ...
      <Button
        ...
        onClick={changeIt}
        className={clsx(type === 'input' && 'mb-[24px]')}
      >
...
export const CommentComponent: FC<{
  ...
  return (
    <div className="relative flex gap-[20px] flex-col flex-1 rounded-card border border-line bg-surface p-[20px] pt-0">
          ...
          <Fragment key={`comment_${index}_${comment.content}`}>
            <div
              className={clsx(
                ...
                comment?.childrenComment?.length && 'gap-[8px]'
              )}
            >
              <div className="flex gap-[8px]">
                <div className="w-[40px] flex flex-col items-center">
                  <div
                    className={`rounded-pill relative z-[2] text-inkSecondary t-body-emphasis flex justify-center items-center w-[40px] h-[40px] bg-surface border-line border`}
                  >
