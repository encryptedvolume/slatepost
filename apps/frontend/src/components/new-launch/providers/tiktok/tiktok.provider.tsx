...
const TikTokSettings: FC<{
  ...
  const tiktokRestrictionNotice = useMemo(() => {
    ...
    return t(
      ...
      'TikTok restriction: For upload-only video, TikTok does not accept a title or message. The content will default to "#Slate" and you can edit it inside the TikTok app before publishing.'
    );
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="t-control mt-[8px] mb-[16px] text-balance">
        {t(
      ...
      {isUploadMode && <div className="-mt-[24px] mb-[24px] text-critical">After posting you fill find a notification inside your Inbox about your post (not content studio)</div>}
      <div className={clsx('flex flex-col', directPostOnly)}>
        ...
        <div className="t-control mt-[8px] mb-[24px] text-balance">
          {t(
        ...
        <div className="flex flex-col gap-[20px]">
          ...
          <div className="t-control my-[8px] text-balance">
            {t(
        ...
        <div className={clsx(!disclose && 'invisible h-0 overflow-hidden', 'mt-[20px]')}>
          ...
          />
          <div className="text-balance my-[8px] t-control">
            {t(
          ...
          {(brand_organic_toggle || brand_content_toggle) && (
            <div className="my-[8px] t-control text-balance">
              {t(
