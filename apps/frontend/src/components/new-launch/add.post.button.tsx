...
export const AddPostButton: FC<{
  ...
  return (
    <div className="flex">
      <div
        onClick={onClick}
        className="select-none cursor-pointer h-control rounded-thumb flex bg-primaryBg gap-[8px] justify-center items-center pl-[16px] pr-[20px] t-secondary-strong mt-[12px]"
      >
        <div>
          <svg
