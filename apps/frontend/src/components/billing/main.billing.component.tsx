...
export const Prorate: FC<{
  ...
  return (
    <div className="t-caption flex pt-[12px]">
...
export const Features: FC<{
  ...
  return (
    <div className="flex flex-col gap-[8px] justify-center t-body text-inkSecondary">
  ...
  return (
    <div>
      ...
      <div className="flex gap-[8px]">
        ...
        <Button onClick={() => resolve(false)} className="!bg-criticalTint text-critical">
...
const Info: FC<{
  ...
  return (
    <div className="relative flex gap-[20px] flex-col flex-1 rounded-thumb">
      <div>
        {t(
  ...
  return (
    <div className="flex flex-col gap-[16px]">
      <div className="flex flex-row">
        <div className="flex-1 t-title-3">{t('plans', 'Plans')}</div>
      ...
      <div className="flex gap-[16px] [@media(max-width:1024px)]:flex-col [@media(max-width:1024px)]:text-center">
        {Object.entries(pricing)
          ...
          .map(([name, values]) => (
            <div
              key={name}
              className="flex-1 bg-surface border border-line rounded-card p-[20px] gap-[16px] flex flex-col [@media(max-width:1024px)]:items-center"
            >
              <div className="t-title-3">{name}</div>
              <div className="t-display tabular flex gap-[4px] items-center">
                <div>
                  $
                  {monthlyOrYearly === 'on'
                    ? values.year_price
              ...
              <div className="t-control flex gap-[8px]">
      ...
      {!!subscription?.id && (
        <div className="flex justify-center mt-[20px] gap-[8px]">
          ...
          {isGeneral && !subscription?.cancelAt && (
            <Button
              className="bg-criticalTint text-critical"
              loading={loading}
