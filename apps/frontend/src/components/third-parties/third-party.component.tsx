    ...
    <div className="cursor-pointer relative select-none" onClick={changeShow}>
      ...
      >
        <path
          ...
          fill="var(--slate-text-tertiary)"
        />
      </svg>
      {show && (
        <div
          onClick={(e) => e.stopPropagation()}
          className={`absolute top-[100%] start-0 p-[8px] px-[20px] bg-fifth flex flex-col gap-[16px] z-[100] rounded-control border border-tableBorder text-nowrap`}
        >
          <div
        ...
        <div className="flex gap-[12px] flex-col">
          ...
          <div className="flex flex-col gap-[8px]">
            <div className="flex-1 flex flex-col gap-[16px]">
              <div
                className={clsx(
                  'gap-[16px] flex flex-col relative justify-center rounded-e-control'
                )}
              >
                {!isLoading && !data?.length ? (
                  ...
                  data?.map((p: any) => (
                    ...
                    >
                      <div
                        className={clsx(
                          'relative rounded-pill flex justify-center items-center'
                        )}
