...
export const Total: FC<{
  ...
  return (
    <div className="flex flex-col gap-[8px] relative w-[158px]">
      <div className="t-control text-inkSecondary">{t('total', 'Total')}</div>
      <div
        className={clsx(
      ...
      >
        <div className="flex-1 px-[16px] t-control select-none flex gap-[8px] items-center">
          <div
            onClick={changeNumber(value - 1)}
            className={clsx(
              'flex items-center',
              value === 1 ? 'text-inkTertiary' : 'text-ink'
            )}
          >
            <svg
          ...
          <div className="flex-1 text-ink t-control text-center">{value}</div>
          <div
            onClick={changeNumber(value + 1)}
