...
export const CustomSelect: FC<{
  ...
  return (
    <div className={clsx('flex flex-col gap-[8px] relative', className)}>
      {!!label && (
      ...
      <div
        ...
        onClick={changeOpen}
      >
        <div className="flex-1 ps-[16px] t-control select-none flex gap-[8px]">
          {!!option.icon && (
        ...
        <div className="pe-[16px] flex gap-[8px] text-inkTertiary">
          <div>
            <svg
        ...
        >
          {options.map((option) => (
            ...
            >
              ...
              <div className="flex-1 t-control">{option.label}</div>
            </div>
          ))}
        </div>
      )}
      {!removeError && (
        <div className="text-critical t-secondary">
          {(err as any) || <>&nbsp;</>}
        </div>
      )}
    </div>
