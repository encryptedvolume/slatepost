<p align="center">
  <a href="https://slatepost.lol/" target="_blank">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://github.com/user-attachments/assets/765e9d72-3ee7-4a56-9d59-a2c9befe2311">
    <img alt="Slate Logo" src="https://github.com/user-attachments/assets/f0d30d70-dddb-4142-8876-e9aa6ed1cb99" width="280"/>
  </picture>
  </a>
</p>
...
<h3 align="center"><strong><a href="https://github.com/gitroomhq/postiz-agent">NEW: check out the Slate agent CLI! perfect for OpenClaw and other agents</a></strong></h3>
<div align="center">
  <strong>
  <h2>One channel. Every post on time.</h2><br />
  <a href="https://slatepost.lol">Slate</a>: An alternative to: Buffer.com, Hypefury, Twitter Hunter, etc...<br /><br />
  </strong>
  Slate offers everything you need to manage your social media posts,<br />build an audience, capture leads, and grow your business.
</div>
...
<p align="center">
  <br />
  <a href="https://docs.slatepost.lol" rel="dofollow"><strong>Explore the docs »</strong></a>
  <br />
...
<p align="center">
  <a href="https://platform.slatepost.lol">Register</a>
  ·
  <a href="https://discord.slatepost.lol">Join Our Discord (devs only)</a>
  ·
  <a href="https://docs.slatepost.lol/public-api">Public API</a><br />
</p>
<p align="center">
...
## 🔌 See the leading Slate features

<p align="center">
  <a href="https://www.youtube.com/watch?v=BdsCVvEYgHU" target="_blank">
    <img alt="Slate" src="https://github.com/user-attachments/assets/8b9b7939-da1a-4be5-95be-42c6fce772de" />
  </a>
</p>
...
To have the project up and running, please follow the [Quick Start Guide](https://docs.slatepost.lol/quickstart)

## Sponsor Slate

We now give a few options to Sponsor Slate:
- Just a donation: You like what we are building, and want to buy us some coffee so we can build faster.
- Main repository: Get your logo with a backlink from the main Slate repository. Slate has over 7M downloads and 20k views per month.

Link: https://opencollective.com/postiz

## Slate Compliance

- Slate is an open-source, self-hosted social media scheduling tool that supports platforms like X (formerly Twitter), Bluesky, Mastodon, Discord, and others.
- Slate hosted service uses official, platform-approved OAuth flows.
- Slate does not automate or scrape content from social media platforms.
- Slate does not collect, store, or proxy API keys or access tokens from users.
- Slate never asks users to paste API keys into our hosted product.
- Slate users always authenticate directly with the social platform (e.g., X, Discord, etc.), ensuring platform compliance and data privacy.
